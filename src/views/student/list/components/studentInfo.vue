  ...
  <div>
    <form>
      <table width="800" cellspacing="1" border="0" align="center">
        <tbody>
          <tr>
            <td class="tableHead" height="35" bgcolor="#D9F0FF" align="center">
              修改学生信息
            </td>
          </tr>
          <tr>
                  ...
                  <tr height="50">
                    ...
                    <td bgcolor="#FFFFFF" align="center">
                      <el-select v-model="dataForm.campus">
                        <el-option :value="1" label="本部校区"></el-option>
                        <el-option :value="2" label="净月校区"></el-option>
                      </el-select>
                    </td>
                  </tr>
                  <tr height="50">
  ...
  methods: {
    ...
    submit() {
      const data = {
        ...
        balanceRiyong: this.dataForm.balanceRiyong,
